  ...
  return (
    <>
       ...
       <div name='work' className='bg-[#fafafa] w-full h-[1000px] text-[#474554]'>
        ...
        {/*Container*/}
        <div className='grid sm:grid-cols-1 md:grid-cols-8 gap-4 text-[#474554] h-full'>

                {/*Grid item */}
                <div 
                className='flex text-left text-[#474554] text-[25em]'>
            ...
            <div 
                className='group container justify-center items-center description--content h-full'>
